...
/***/ "./src/js/modules/init-header-article.js":
/*!***********************************************!*\
  !*** ./src/js/modules/init-header-article.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initHeaderArticle": () => (/* binding */ initHeaderArticle)
/* harmony export */ });
...
/***/ "./src/js/modules/init-header-scroll.js":
/*!**********************************************!*\
  !*** ./src/js/modules/init-header-scroll.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
function onModalCloseKeyDown(e) {
  if ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.isEscEvent)(e)) {
    closeModal();
  }
}
...
/***/ "./src/js/modules/init-navigation.js":
/*!*******************************************!*\
  !*** ./src/js/modules/init-navigation.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initSplide": () => (/* binding */ initSplide)
/* harmony export */ });
...
const initSplide = () => {
  document.addEventListener('DOMContentLoaded', () => {
    if (investmentSplide) {
      new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](investmentSplide, {
        role: 'region',
        type: 'loop',
        drag: 'free',
        focus: 'left',
...
/* harmony export */ });
/* harmony import */ var _init_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./init-modal.js */ "./src/js/modules/init-modal.js");
/* harmony import */ var _validate_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validate-form.js */ "./src/js/modules/validate-form.js");
  ...
  window.addEventListener('DOMContentLoaded', () => {
    forms.forEach(form => {
      form.addEventListener('submit', async e => {
        e.preventDefault();
        const error = (0,_validate_form_js__WEBPACK_IMPORTED_MODULE_1__.validateForm)(form);
        if (error === 0) {
          (0,_init_modal_js__WEBPACK_IMPORTED_MODULE_0__.openModalSuccess)();
          form.reset();
        }
      });
    });
...
/* harmony export */   "onNameDigits": () => (/* binding */ onNameDigits),
/* harmony export */   "onPhoneDigits": () => (/* binding */ onPhoneDigits),
...
const onNameDigits = e => {
  if ('1234567890'.indexOf(e.key) !== -1) {
    e.preventDefault();
  }
};
const onPhoneDigits = e => {
  if (e.keyCode === 46 || e.keyCode === 8 || e.keyCode === 9 || e.keyCode === 27 ||
  // Разрешаем: Ctrl+A
  e.keyCode === 189 && e.shiftKey === false || e.keyCode === 187 && e.shiftKey === true || e.keyCode === 67 && e.ctrlKey === true || e.keyCode === 65 && e.ctrlKey === true ||
  // Разрешаем: home, end, влево, вправо
  e.keyCode >= 35 && e.keyCode <= 39 || e.keyCode === 86 && e.ctrlKey === true) {
    // Ничего не делаем
  } else {
...
/* harmony import */ var _modules_init_header_scroll_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-header-scroll.js */ "./src/js/modules/init-header-scroll.js");
...
/* harmony import */ var _modules_defocus_button_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/defocus-button.js */ "./src/js/modules/defocus-button.js");
/* harmony import */ var _modules_init_header_article_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-header-article.js */ "./src/js/modules/init-header-article.js");
/* harmony import */ var _modules_init_timer_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-timer.js */ "./src/js/modules/init-timer.js");
/* harmony import */ var _modules_init_navigation_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-navigation.js */ "./src/js/modules/init-navigation.js");
/* harmony import */ var _modules_init_splide_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-splide.js */ "./src/js/modules/init-splide.js");
/* harmony import */ var _modules_init_modal_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-modal.js */ "./src/js/modules/init-modal.js");
/* harmony import */ var _modules_send_form_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/send-form.js */ "./src/js/modules/send-form.js");
...
(0,_modules_defocus_button_js__WEBPACK_IMPORTED_MODULE_5__.defocusButton)();
...
(0,_modules_init_header_article_js__WEBPACK_IMPORTED_MODULE_6__.initHeaderArticle)();
(0,_modules_init_timer_js__WEBPACK_IMPORTED_MODULE_7__.initTimer)();
(0,_modules_init_navigation_js__WEBPACK_IMPORTED_MODULE_8__.initNavigation)();
(0,_modules_init_splide_js__WEBPACK_IMPORTED_MODULE_9__.initSplide)();
(0,_modules_init_modal_js__WEBPACK_IMPORTED_MODULE_10__.initModal)();
(0,_modules_send_form_js__WEBPACK_IMPORTED_MODULE_11__.sendForm)();
})();
